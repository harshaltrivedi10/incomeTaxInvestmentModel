...
<head>
    ...
    <meta charset="utf-8">
    <title>IncomeTAX Investment</title>
    ...
    <link href='bower_components/bootstrap-tour/buildha/css/bootstrap-tour.min.css' rel='stylesheet'>
...
<div class="ch-container">
    ...
    <div class="row">
        <div class="col-md-12 center login-header">
            <h2>Welcome to Income Tax Model</h2>
        </div>
        <!--/span-->
    </div><!--/row-->
                 ...
                 <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="Username"></asp:TextBox>
                    ...
                    <p class="center col-md-5">
                     <asp:Button ID="Button1" runat="server" Text="Login" class="btn btn-primary" OnClick="Button1_Click" />
                        <br />
                     <asp:Label ID="Label1" runat="server" Text="Label" Visible="false" ForeColor="#3a87ad"></asp:Label>
